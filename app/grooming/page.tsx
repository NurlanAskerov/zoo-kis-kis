...
const detailCopy: Record<Lang, {
  ...
  ru: {
    intro: 'Груминг помогает питомцам оставаться чистыми, ухоженными и чувствовать себя комфортно. Цена и время уточняются по виду/породе питомца, состоянию шерсти и выбранной услуге.',
    howTitle: 'Как проходит груминг?',
    howText: 'После заявки данные открываются готовым сообщением в WhatsApp. Команда учитывает вид/породу питомца и услугу, затем подтверждает удобное время.',
    steps: ['Укажите вид/породу питомца', 'Выберите нужную услугу', 'Предложите удобный день и время', 'Магазин подтвердит запись в WhatsApp'],
    cards: [
      { title: 'Стрижка', text: 'Учитываются длина шерсти, колтуны и комфорт питомца.' },
      { title: 'Мытьё и сушка', text: 'Чистка и сушка выполняются с учётом вида питомца.' },
      { title: 'Расчёсывание', text: 'Подходит для удаления лишней шерсти и распутывания.' },
