...
const copy = {
  ...
  ru: {
    ...
    text: 'Регистрация не нужна. Имя, телефон и адрес сохраняются в браузере и автоматически добавляются в WhatsApp-сообщения заказа/заявки.',
    fullName: 'Имя и фамилия', phone: 'Телефон', city: 'Город', address: 'Адрес', delivery: 'Тип доставки', petType: 'Вид / размер питомца', petName: 'Имя питомца', note: 'Дополнительная заметка', save: 'Сохранить данные', saved: 'Данные подтверждены', ready: 'Эти данные будут использоваться в заказах и заявках на груминг.', notSaved: 'Заполните поля и нажмите сохранить.'
  }
};
