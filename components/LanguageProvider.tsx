...
const dictionaries: Record<Lang, Dict> = {
  ...
  ru: {
    ...
    why: 'Почему выбирают нас?', whyTitle: 'Почему выбирают Zoo Kis-Kis?', catalog: 'Удобный выбор', catalogText: 'Товары удобно распределены по категориям для кошек, собак, птиц, рыб и хомяков, а фильтры помогают быстро найти корма, лежанки, туалеты и аксессуары.', care: 'Зоомагазин и уход в одном месте', careText: 'Каталог, услуги груминга, адрес и контакты собраны в одном месте, поэтому оформить заказ можно быстро и без лишних шагов.',
    discountedProducts: 'Товары со скидкой', popularProducts: 'Популярные товары', newProducts: 'Новинки', seeAll: 'Смотреть все',
    groomingTitle: 'Быстрая заявка на груминг', groomingText: 'Отправьте короткую заявку на стрижку, мытьё, расчёсывание или уход за когтями — команда согласует удобное время в WhatsApp.', groomingPage: 'Страница груминга', groomingHomeNote: 'Адрес не требуется. Укажите вид питомца, размер, услугу и удобное время.', applyNow: 'Оставить заявку', deliveryTitle: 'Доставка и самовывоз', metro: 'Доставка до станции метро', addressDelivery: 'Доставка по адресу', regionPost: 'Отправка в регионы', moreInfo: 'Подробнее',
    deliveryText: 'Доставка и самовывоз до станции метро, доставки по адресу и отправки в регионы указаны отдельно.',
    deliveryBenefitText: 'Стоимость и сроки доставки понятны ещё до оформления заказа.',
