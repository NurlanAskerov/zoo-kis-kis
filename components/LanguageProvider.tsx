...
const dictionaries: Record<Lang, Dict> = {
  az: {
    ...
    deliveryTitle: 'Bolt ilə çatdırılma',
    metro: 'Bolt çatdırılma',
    addressDelivery: 'Bolt çatdırılma',
    regionPost: 'Bolt çatdırılma',
    moreInfo: 'Ətraflı məlumat',
    deliveryText: 'Çatdırılma yalnız Bolt vasitəsilədir. Sifarişlər hər gün 10:00-dan 22:00-dək göndərilir.',
    deliveryBenefitText: 'Çatdırılma yalnız Bolt ilə, hər gün 10:00–22:00 aralığında aktivdir.',
    ...
    remove: 'Sil',
    summary: 'Yekun',
    deliveryPriceInfo: 'Çatdırılma Bolt vasitəsilədir və hər gün 10:00–22:00 aralığında aktivdir.',
    ...
    deliveryPageTitle: 'Bolt ilə çatdırılma',
    deliveryPageText: 'Çatdırılma yalnız Bolt vasitəsilədir',
  ...
  ru: {
    ...
    groomingTitle: 'Быстрая заявка на груминг', groomingText: 'Отправьте короткую заявку на стрижку, купание, расчёсывание или уход за когтями — команда согласует удобное время в WhatsApp.', groomingPage: 'Страница груминга', groomingHomeNote: 'Адрес не требуется. Укажите вид питомца, размер, услугу и удобное время.', applyNow: 'Оставить заявку', deliveryTitle: 'Доставка через Bolt', metro: 'Доставка до станции метро', addressDelivery: 'Доставка Bolt', regionPost: 'Доставка Bolt', moreInfo: 'Подробнее',
    deliveryText: 'Доставка осуществляется только через Bolt. Заказы доставляются каждый день с 10:00 до 22:00.',
    deliveryBenefitText: 'Доставка доступна только через Bolt, каждый день с 10:00 до 22:00.',
    ...
    deliveryPageTitle: 'Доставка через Bolt', deliveryPageText: 'Доставка осуществляется только через Bolt', toMetro: 'Платформа доставки', toAddress: 'Время работы', toRegions: 'Примечание',
