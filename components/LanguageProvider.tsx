...
const dictionaries: Record<Lang, Dict> = {
  az: {
    ...
    catalog: 'Rahat seçim',
    catalogText: 'Məhsullar pişik, it, quş, balıq və xomyak üzrə ayrılıb. Yem, yuva, biotualet və aksesuar kimi seçimlər filtrdə aydın görünür.',
    ...
    deliveryTitle: 'Çatdırılma və mağazadan təhvil alma',
    metro: 'Metrolara çatdırılma',
    addressDelivery: 'Ünvana çatdırılma',
    regionPost: 'Bölgələrə poçtla göndəriş',
    moreInfo: 'Ətraflı məlumat',
    deliveryText: 'Çatdırılma saatı, metroya çatdırılma, ünvana çatdırılma və bölgələrə poçt göndərişi şərtləri ayrıca göstərilir.',
    deliveryBenefitText: 'Çatdırılma qiyməti və müddəti istifadəçiyə əvvəlcədən aydın görünür.',
    ...
    categoryHamstersTitle: 'Xomyak məhsulları',
    categoryHamstersText: 'Xomyak qəfəsləri, yemlər və aksesuarlar',
    ...
    cartText: 'Səbət məlumatları brauzerdə saxlanılır. Backend qoşulduqda sifarişlər bazaya yazılacaq.',
    remove: 'Sil',
    summary: 'Yekun',
    deliveryPriceInfo: 'Çatdırılma qiyməti sifariş ünvanına görə razılaşdırılır.',
    ...
    deliveryPageTitle: 'Çatdırılma xidməti başladı',
    deliveryPageText: 'Çatdırılma saatı',
    toMetro: 'Metrolara',
    toAddress: 'Ünvana',
    toRegions: 'Bölgələrə',
    ...
    adminText: 'Bu hissə hazır interfeysdir. Backend/database qoşulduqda məhsul, şəkil, stok, çatdırılma və sifarişlər buradan idarə ediləcək.',
    ...
    groomingMiniStep1: 'Heyvanın növünü və cinsini yazın: məsələn, çihuahua iti, pişik, xomyak.',
    ...
    adminLoginText: 'Məhsul əlavə etmək və aktiv/passiv etmək üçün .env-də yazdığınız admin şifrəsini daxil edin.',
  ...
  en: {
    ...
    cartEmptyTitle: 'Your cart is empty.', cartEmptyText: 'Browse products and add what your pet needs.', goToProducts: 'Go to products', cartTitle: 'Complete your order', cartText: 'Cart data is stored in the browser. When backend is connected, orders will be saved to the database.', remove: 'Remove', summary: 'Summary', deliveryPriceInfo: 'Delivery price is agreed based on the order address.', checkout: 'Complete order', clearCart: 'Clear cart',
    checkoutKicker: 'Checkout', checkoutTitle: 'Order information', checkoutText: 'Cart items turn into a ready WhatsApp message. If you save your profile once, details are filled automatically next time.', fullName: 'Full name', phone: 'Phone', address: 'Address', deliveryType: 'Delivery type', postDelivery: 'Postal delivery', note: 'Additional note', sendOrder: 'Send order', whatsappFastTitle: 'Order faster via WhatsApp', whatsappFastText: 'Press the button, check your details, and send the ready order text on WhatsApp.',
    contactTitle: 'Contact us', sendMessage: 'Send a message', yourName: 'Your name', yourMessage: 'Your message', send: 'Send',
    deliveryPageTitle: 'Delivery service has started', deliveryPageText: 'Delivery time', toMetro: 'To metro stations', toAddress: 'To address', toRegions: 'To regions',
    ...
    adminPanel: 'Admin panel', adminTitle: 'Management panel', adminText: 'This is a ready interface. Once backend/database is connected, products, images, stock, delivery and orders will be managed here.', productList: 'Product list', addProduct: 'Add product', deliverySettings: 'Delivery settings', orders: 'Orders', productName: 'Product name', chooseCategory: 'Choose category', imagePath: 'Image URL or upload path', save: 'Save', settings: 'Settings', updateSettings: 'Update settings', lastOrders: 'Recent orders', customer: 'Customer', status: 'Status', amount: 'Amount', demoCustomer: 'Demo customer', pending: 'Pending', confirmed: 'Confirmed', whatsappOrder: 'WhatsApp order', name: 'Name', otherImages: 'Other images', call: 'Call', close: 'Close', favoritesTitle: 'Your favorite products', favoritesText: 'Products you liked are saved here. You can add them to cart anytime.', favoritesEmptyTitle: 'No favorite products yet.', favoritesEmptyText: 'Tap the heart icon on product cards to save products here.', favoriteProducts: 'Your favorites', similarProducts: 'Similar products', sameTypeProducts: 'Same product type', moreForThisPet: 'For this pet type', recommendedForYou: 'Picked for you', clearFavorites: 'Clear favorites', city: 'City', saveProfile: 'Save details', sendWhatsappOrder: 'Send order via WhatsApp', sendToWhatsapp: 'Send to WhatsApp', profileSaved: 'Details saved', profileFormHint: 'Fill your profile once and it will be reused in orders and WhatsApp requests.', groomingFormTitle: 'Grooming request form', groomingFormText: 'Press Apply now to open the form. Name and phone are prefilled if saved in your profile; otherwise fill them in the form and send.', groomingMiniStep1: 'Write the pet type or breed, for example Chihuahua dog, cat or hamster.', groomingMiniStep2: 'Choose the needed service and add a preferred day.', groomingMiniStep3: 'The message opens ready in WhatsApp and the store confirms the suitable time.', petTypeInput: 'Pet type / breed', petName: 'Pet name', preferredTime: 'Preferred day and time', groomerApplyHint: 'You can send work examples via WhatsApp or Instagram direct.', adminLoginTitle: 'Admin login', adminLoginText: 'Enter the admin password from .env to add products and manage active status.', adminPassword: 'Admin password', login: 'Login', logout: 'Logout', adminProductEditor: 'Fill product details', adminProductEditorText: 'AZ is required; EN/RU can be empty and will use AZ fallback. The live product card shows how it appears on the site.', productPreview: 'Product card preview', previewText: 'This card is how users will see the product.', filtersAndPrice: 'Filters and price', imagesAndBadge: 'Images and red badge', mainImagePath: 'Main image path', extraImagePaths: 'Extra images - one path per line', oldPriceField: 'Old price for discount', activeProduct: 'Product is active', inactiveProduct: 'Product is inactive', saving: 'Saving', checkoutSimpleText: 'Send your order to WhatsApp without a long checkout. The needed details will appear in the modal.', profileReadyOrder: 'Profile details found and will be prefilled in the order modal.', profileMissingOrder: 'If your profile is empty, you can fill the details in the order modal.', orderModalTitle: 'Check the order message', orderProfileFound: 'Your profile details were found and the form is prefilled.', orderProfileMissing: 'No profile details yet. Fill the required fields, then send.', messagePreview: 'Message preview', profileReadyGrooming: 'Profile details found. Name and phone will be prefilled in the grooming modal.', profileMissingGrooming: 'If your profile is empty, only name and phone are needed in the grooming modal.', groomingModalTitle: 'Check the grooming request'
  },
  ru: {
    home: 'Главная', products: 'Товары', grooming: 'Груминг', delivery: 'Доставка', about: 'О нас', contact: 'Контакты', cart: 'Корзина', favorites: 'Избранное', profile: 'Профиль', menu: 'Меню', categories: 'Категории', workHours: 'Время работы', demoCopy: 'Next.js e-commerce демо',
    heroKicker: 'Зоомагазин • Груминг • Pet care', heroTitle: 'Удобные покупки для ваших питомцев.', heroText: 'В Zoo Kis-Kis корма, аксессуары, товары для ухода и услуги груминга собраны в одном месте.', viewProducts: 'Смотреть товары', orderGrooming: 'Записаться на груминг', whatsapp: 'Написать в WhatsApp', deliveryAvailable: 'Есть доставка', easyChoice: 'Удобный выбор', petCare: 'Pet care поддержка', saleLabel: 'Скидки',
    why: 'Почему мы?', whyTitle: 'Почему удобно выбрать Zoo Kis-Kis?', catalog: 'Удобный выбор', catalogText: 'Товары разделены для кошек, собак, птиц, рыб и хомяков, а фильтры по корму, лежанкам, туалетам и аксессуарам понятны сразу.', care: 'Магазин и уход вместе', careText: 'Товары, груминг, адрес и контакты собраны в одном месте, поэтому клиент может оформить заказ без лишнего поиска.',
    discountedProducts: 'Товары со скидкой', popularProducts: 'Популярные товары', newProducts: 'Новинки', seeAll: 'Показать все',
    groomingTitle: 'Удобная заявка на груминг', groomingText: 'Отправьте короткие данные для стрижки, мытья, расчёсывания или ухода за когтями. Команда подтвердит удобное время в WhatsApp.', groomingPage: 'Страница груминга', groomingHomeNote: 'Адрес не нужен. Укажите вид питомца, размер, услугу и удобное время.', applyNow: 'Подать заявку', deliveryTitle: 'Доставка и самовывоз', metro: 'Доставка к метро', addressDelivery: 'Доставка по адресу', regionPost: 'Отправка в регионы', moreInfo: 'Подробнее',
    deliveryText: 'Время доставки, доставка к метро, доставка по адресу и отправка в регионы почтой показаны отдельно.',
    deliveryBenefitText: 'Стоимость и сроки доставки понятны клиенту до связи с магазином.',
    toastAdded: 'добавлен в корзину',
    toastRemoved: 'удалён из корзины',
    toastCleared: 'Корзина очищена',
    addToCart: 'В корзину', details: 'Подробнее', price: 'Цена', stock: 'Наличие', productDetails: 'Детали товара', backToProducts: 'Назад к товарам', shareOnWhatsapp: 'Спросить в WhatsApp',
    productsKicker: 'Каталог зоомагазина', productsTitle: 'Легко найдите нужный товар', productsText: 'Фильтруйте товары для собак, кошек и других питомцев по виду питомца, категории и типу товара.', allProducts: 'Все товары', petType: 'Вид питомца', productType: 'Подкатегория', department: 'Раздел', subcategory: 'Подкатегория', allInDepartment: 'Все в этом разделе', category: 'Категория', collection: 'Подборка', clearFilters: 'Сбросить фильтры', results: 'результатов', noProducts: 'Нет товаров по выбранным фильтрам.', all: 'Все', searchProducts: 'Поиск по названию товара', filters: 'Фильтры', filterHint: 'Сначала выберите вид питомца, затем раздел и подкатегорию — так товары проще найти.', filterResultsSuffix: 'результаты:', showResults: 'Показать результаты', shareProduct: 'Поделиться',
    categoryCatsTitle: 'Товары для кошек', categoryCatsText: 'Корма, наполнители, биотуалеты и игрушки', categoryDogsTitle: 'Товары для собак', categoryDogsText: 'Корма, лежанки, переноски и поводки', categoryBirdsTitle: 'Товары для птиц', categoryBirdsText: 'Клетки и аксессуары для птиц', categoryFishTitle: 'Товары для рыб', categoryFishText: 'Аквариумы, корм для рыб и аксессуары', categoryHamstersTitle: 'Товары для хомяков', categoryHamstersText: 'Клетки, корм и аксессуары для хомяков',
    aboutKicker: 'О нас', aboutTitle: 'Что делает Zoo Kis-Kis?', aboutText: 'Zoo Kis-Kis — это pet care пространство, объединяющее зоомагазин и груминг. Наша цель — простой каталог, быстрая связь и правильный выбор товаров для питомцев.', aboutPoint1: 'Сухой корм, влажный корм, игрушки и аксессуары', aboutPoint2: 'Груминг и уход', aboutGreenTitle: 'Ближе к вашим любимцам.', aboutGreenText: 'Используйте карту и социальные сети, чтобы быстро связаться с магазином.', mapAndSocial: 'Карта и социальные сети', mapAndSocialText: 'Посмотрите адрес на карте, откройте Instagram и TikTok или быстро напишите в WhatsApp.',
    cartEmptyTitle: 'Ваша корзина пока пуста.', cartEmptyText: 'Посмотрите товары и добавьте всё необходимое для питомца.', goToProducts: 'Перейти к товарам', cartTitle: 'Завершите заказ', cartText: 'Данные корзины хранятся в браузере. После подключения backend заказы будут сохраняться в базу данных.', remove: 'Удалить', summary: 'Итого', deliveryPriceInfo: 'Стоимость доставки согласуется по адресу заказа.', checkout: 'Оформить заказ', clearCart: 'Очистить корзину',
    checkoutKicker: 'Оформление', checkoutTitle: 'Информация о заказе', checkoutText: 'Товары из корзины превращаются в готовое сообщение WhatsApp. Если сохранить профиль один раз, данные будут подставляться автоматически.', fullName: 'Имя и фамилия', phone: 'Телефон', address: 'Адрес', deliveryType: 'Тип доставки', postDelivery: 'Почтовая отправка', note: 'Дополнительная заметка', sendOrder: 'Отправить заказ', whatsappFastTitle: 'Быстрый заказ через WhatsApp', whatsappFastText: 'Нажмите кнопку, проверьте данные и отправьте готовый текст заказа в WhatsApp.',
    ...
    deliveryPageTitle: 'Служба доставки запущена', deliveryPageText: 'Время доставки', toMetro: 'К метро', toAddress: 'По адресу', toRegions: 'В регионы',
    groomingPageTitle: 'Груминг и уход', groomingPageText: 'Отправьте готовую заявку в WhatsApp на стрижку, мытьё, расчёсывание, гигиену и уход за когтями.', bookGrooming: 'Записаться на груминг', groomingBookText: 'Цена может зависеть от вида питомца, размера и услуги. Самый удобный способ — написать в WhatsApp.', serviceTypes: 'Виды услуг', workWithUs: 'Работайте с нами', groomerTitle: 'У вас есть профессиональные навыки груминга?', groomerText: 'Свяжитесь с нами, чтобы работать с командой Zoo Kis-Kis. Опытные грумеры могут отправить примеры работ через WhatsApp или Instagram direct.', apply: 'Откликнуться',
    adminPanel: 'Админ-панель', adminTitle: 'Панель управления', adminText: 'Это готовый интерфейс. После подключения backend/database здесь можно будет управлять товарами, изображениями, складом, доставкой и заказами.', productList: 'Список товаров', addProduct: 'Добавить товар', deliverySettings: 'Настройки доставки', orders: 'Заказы', productName: 'Название товара', chooseCategory: 'Выберите категорию', imagePath: 'URL изображения или путь загрузки', save: 'Сохранить', settings: 'Настройки', updateSettings: 'Обновить настройки', lastOrders: 'Последние заказы', customer: 'Клиент', status: 'Статус', amount: 'Сумма', demoCustomer: 'Демо-клиент', pending: 'В ожидании', confirmed: 'Подтверждено', whatsappOrder: 'WhatsApp заказ', name: 'Название', otherImages: 'Другие изображения', call: 'Позвонить', close: 'Закрыть', favoritesTitle: 'Ваши избранные товары', favoritesText: 'Товары, которые вам понравились, сохраняются здесь. Их можно быстро добавить в корзину.', favoritesEmptyTitle: 'Избранных товаров пока нет.', favoritesEmptyText: 'Нажмите на сердечко в карточке товара, чтобы сохранить его здесь.', favoriteProducts: 'Ваше избранное', similarProducts: 'Похожие товары', sameTypeProducts: 'Товары того же типа', moreForThisPet: 'Для этого питомца', recommendedForYou: 'Подобрали для вас', clearFavorites: 'Очистить избранное', city: 'Город', saveProfile: 'Сохранить данные', sendWhatsappOrder: 'Отправить заказ в WhatsApp', sendToWhatsapp: 'Отправить в WhatsApp', profileSaved: 'Данные сохранены', profileFormHint: 'Заполните профиль один раз, и он будет использоваться в заказах и WhatsApp-заявках.', groomingFormTitle: 'Форма заявки на груминг', groomingFormText: 'Нажмите кнопку заявки, чтобы открыть форму. Имя и телефон подставятся из профиля, если они сохранены; если нет — заполните их в форме и отправьте.', groomingMiniStep1: 'Укажите вид или породу питомца, например собака чихуахуа, кошка или хомяк.', groomingMiniStep2: 'Выберите услугу и удобный день.', groomingMiniStep3: 'Сообщение откроется готовым в WhatsApp, а магазин подтвердит удобное время.', petTypeInput: 'Вид / порода питомца', petName: 'Имя питомца', preferredTime: 'Удобный день и время', groomerApplyHint: 'Примеры работ можно отправить через WhatsApp или Instagram direct.', adminLoginTitle: 'Вход в админ-панель', adminLoginText: 'Введите пароль из .env, чтобы добавлять товары и управлять активностью.', adminPassword: 'Пароль администратора', login: 'Войти', logout: 'Выйти', adminProductEditor: 'Заполните данные товара', adminProductEditorText: 'AZ обязателен; EN/RU можно оставить пустыми, тогда будет использован AZ. Справа видно, как карточка будет выглядеть на сайте.', productPreview: 'Предпросмотр карточки', previewText: 'Так пользователь увидит товар на сайте.', filtersAndPrice: 'Фильтры и цена', imagesAndBadge: 'Изображения и красный бейдж', mainImagePath: 'Путь основного изображения', extraImagePaths: 'Доп. изображения — один путь в строке', oldPriceField: 'Старая цена для скидки', activeProduct: 'Товар активен', inactiveProduct: 'Товар неактивен', saving: 'Сохраняется', checkoutSimpleText: 'Отправьте заказ в WhatsApp без длинного оформления. Нужные данные откроются в модальном окне.', profileReadyOrder: 'Данные профиля найдены и будут подставлены в заказ.', profileMissingOrder: 'Если профиль пустой, заполните данные прямо в окне заказа.', orderModalTitle: 'Проверьте сообщение заказа', orderProfileFound: 'Данные профиля найдены, форма заполнена автоматически.', orderProfileMissing: 'Данных профиля пока нет. Заполните нужные поля и отправьте.', messagePreview: 'Предпросмотр сообщения', profileReadyGrooming: 'Данные профиля найдены. Имя и телефон будут подставлены в заявку на груминг.', profileMissingGrooming: 'Если профиль пустой, в заявке на груминг достаточно указать имя и телефон.', groomingModalTitle: 'Проверьте заявку на груминг'
  }
};
