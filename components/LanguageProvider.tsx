...
const dictionaries: Record<Lang, Dict> = {
  ...
  ru: {
    ...
    heroKicker: 'Зоомагазин • Груминг • Забота о питомцах', heroTitle: 'Удобные покупки для ваших питомцев.', heroText: 'В Zoo Kis-Kis корма, аксессуары, товары для ухода и услуги груминга собраны в одном месте.', viewProducts: 'Смотреть товары', orderGrooming: 'Записаться на груминг', whatsapp: 'Написать в WhatsApp', deliveryAvailable: 'Есть доставка', easyChoice: 'Удобный выбор', petCare: 'Поддержка по уходу', saleLabel: 'Скидки',
    why: 'Почему мы?', whyTitle: 'Почему выбирают Zoo Kis-Kis?', catalog: 'Удобный выбор', catalogText: 'Товары удобно распределены по категориям для кошек, собак, птиц, рыб и хомяков, а фильтры помогают быстро найти корм, лежанки, туалеты и аксессуары.', care: 'Магазин и уход вместе', careText: 'Каталог, услуги груминга, адрес и контакты собраны в одном месте, поэтому оформить заказ можно без лишних шагов.',
    discountedProducts: 'Товары со скидкой', popularProducts: 'Популярные товары', newProducts: 'Новинки', seeAll: 'Смотреть все',
    groomingTitle: 'Быстрая запись на груминг', groomingText: 'Отправьте короткую заявку на стрижку, мытьё, расчёсывание или уход за когтями. Команда согласует удобное время в WhatsApp.', groomingPage: 'Страница груминга', groomingHomeNote: 'Адрес не требуется. Укажите вид питомца, размер, услугу и удобное время.', applyNow: 'Оставить заявку', deliveryTitle: 'Доставка и самовывоз', metro: 'Доставка к метро', addressDelivery: 'Доставка по адресу', regionPost: 'Отправка в регионы', moreInfo: 'Подробнее',
    deliveryText: 'Условия доставки к метро, доставки по адресу и отправки в регионы указаны отдельно.',
    deliveryBenefitText: 'Стоимость и сроки доставки понятны ещё до обращения в магазин.',
    ...
    productsKicker: 'Каталог зоомагазина', productsTitle: 'Быстро найдите нужный товар', productsText: 'Фильтруйте товары по виду питомца, разделу и типу товара.', allProducts: 'Все товары', petType: 'Вид питомца', productType: 'Подкатегория', department: 'Раздел', subcategory: 'Подкатегория', allInDepartment: 'Все в этом разделе', category: 'Категория', collection: 'Подборка', clearFilters: 'Сбросить фильтры', results: 'результатов', noProducts: 'По выбранным фильтрам товары не найдены.', all: 'Все', searchProducts: 'Поиск по названию товара', filters: 'Фильтры', filterHint: 'Сначала выберите вид питомца, затем раздел и подкатегорию — так нужный товар найти проще.', filterResultsSuffix: 'результаты:', showResults: 'Показать результаты', shareProduct: 'Поделиться',
    ...
    aboutKicker: 'О нас', aboutTitle: 'Что делает Zoo Kis-Kis?', aboutText: 'Zoo Kis-Kis — это пространство заботы о питомцах, объединяющее зоомагазин и услуги груминга. Наша цель — удобный каталог, быстрая связь и правильный выбор товаров для ваших любимцев.', aboutPoint1: 'Сухой корм, влажный корм, игрушки и аксессуары', aboutPoint2: 'Груминг и уход', aboutGreenTitle: 'Ближе к вашим питомцам.', aboutGreenText: 'Используйте карту и социальные сети, чтобы быстро связаться с магазином.', mapAndSocial: 'Карта и социальные сети', mapAndSocialText: 'Посмотрите адрес на карте, откройте Instagram и TikTok или быстро напишите в WhatsApp.',
    cartEmptyTitle: 'Ваша корзина пока пуста.', cartEmptyText: 'Посмотрите товары и добавьте всё необходимое для питомца.', goToProducts: 'Перейти к товарам', cartTitle: 'Завершите заказ', cartText: 'Данные корзины сохраняются в браузере. После подключения backend заказы будут сохраняться в базе данных.', remove: 'Удалить', summary: 'Итого', deliveryPriceInfo: 'Стоимость доставки согласуется по адресу заказа.', checkout: 'Оформить заказ', clearCart: 'Очистить корзину',
    checkoutKicker: 'Оформление', checkoutTitle: 'Информация о заказе', checkoutText: 'Товары из корзины автоматически формируются в готовое сообщение для WhatsApp. Если один раз сохранить профиль, данные будут подставляться автоматически.', fullName: 'Имя и фамилия', phone: 'Телефон', address: 'Адрес', deliveryType: 'Тип доставки', postDelivery: 'Отправка почтой', note: 'Комментарий к заказу', sendOrder: 'Отправить заказ', whatsappFastTitle: 'Быстрый заказ через WhatsApp', whatsappFastText: 'Нажмите кнопку, проверьте данные и отправьте готовый текст заказа в WhatsApp.',
    ...
    deliveryPageTitle: 'Условия доставки', deliveryPageText: 'Время и условия доставки', toMetro: 'К станции метро', toAddress: 'Доставка по адресу', toRegions: 'Отправка в регионы',
    groomingPageTitle: 'Груминг и уход', groomingPageText: 'Отправьте заявку в WhatsApp на стрижку, мытьё, расчёсывание, гигиенический уход и уход за когтями.', bookGrooming: 'Записаться на груминг', groomingBookText: 'Цена зависит от вида питомца, размера и выбранной услуги. Самый удобный способ уточнить детали — написать в WhatsApp.', serviceTypes: 'Виды услуг', workWithUs: 'Работайте с нами', groomerTitle: 'Вы профессиональный грумер?', groomerText: 'Свяжитесь с нами, если хотите сотрудничать с командой Zoo Kis-Kis. Опытные грумеры могут отправить примеры работ через WhatsApp или Direct в Instagram.', apply: 'Откликнуться',
    adminPanel: 'Админ-панель', adminTitle: 'Панель управления', adminText: 'Это готовый интерфейс управления. После подключения базы данных и backend здесь можно будет управлять товарами, изображениями, остатками, доставкой и заказами.', productList: 'Список товаров', addProduct: 'Добавить товар', deliverySettings: 'Настройки доставки', orders: 'Заказы', productName: 'Название товара', chooseCategory: 'Выберите категорию', imagePath: 'URL изображения или путь загрузки', save: 'Сохранить', settings: 'Настройки', updateSettings: 'Обновить настройки', lastOrders: 'Последние заказы', customer: 'Клиент', status: 'Статус', amount: 'Сумма', demoCustomer: 'Демо-клиент', pending: 'В ожидании', confirmed: 'Подтверждено', whatsappOrder: 'WhatsApp заказ', name: 'Название', otherImages: 'Другие изображения', call: 'Позвонить', close: 'Закрыть', favoritesTitle: 'Избранные товары', favoritesText: 'Здесь сохраняются товары, которые вам понравились. Их можно быстро добавить в корзину.', favoritesEmptyTitle: 'Избранных товаров пока нет.', favoritesEmptyText: 'Нажмите на сердечко в карточке товара, чтобы сохранить его здесь.', favoriteProducts: 'Избранное', similarProducts: 'Похожие товары', sameTypeProducts: 'Товары того же типа', moreForThisPet: 'Для этого вида питомца', recommendedForYou: 'Подобрали для вас', clearFavorites: 'Очистить избранное', city: 'Город', saveProfile: 'Сохранить данные', sendWhatsappOrder: 'Отправить заказ в WhatsApp', sendToWhatsapp: 'Отправить в WhatsApp', profileSaved: 'Данные сохранены', profileFormHint: 'Заполните профиль один раз — данные будут использоваться в заказах и заявках WhatsApp.', groomingFormTitle: 'Форма заявки на груминг', groomingFormText: 'Нажмите кнопку заявки, чтобы открыть форму. Имя и телефон подставятся из профиля, если они сохранены. Если данных нет — заполните форму вручную и отправьте.', groomingMiniStep1: 'Укажите вид или породу питомца, например: собака чихуахуа, кошка или хомяк.', groomingMiniStep2: 'Выберите услугу и удобный день.', groomingMiniStep3: 'Готовое сообщение откроется в WhatsApp, а магазин подтвердит удобное время.', petTypeInput: 'Вид или порода питомца', petName: 'Имя питомца', preferredTime: 'Удобный день и время', groomerApplyHint: 'Примеры работ можно отправить через WhatsApp или Instagram direct.', adminLoginTitle: 'Вход в админ-панель', adminLoginText: 'Введите пароль из .env, чтобы добавлять товары и управлять их активностью.', adminPassword: 'Пароль администратора', login: 'Войти', logout: 'Выйти', adminProductEditor: 'Заполните данные товара', adminProductEditorText: 'Поле AZ обязательно. EN/RU можно оставить пустыми — тогда будет использован текст AZ. Справа показано, как карточка будет выглядеть на сайте.', productPreview: 'Предпросмотр карточки', previewText: 'Так пользователь увидит товар на сайте.', filtersAndPrice: 'Фильтры, цена и остаток', imagesAndBadge: 'Изображения и бейдж', mainImagePath: 'Путь к основному изображению', extraImagePaths: 'Дополнительные изображения — по одному пути в строке', oldPriceField: 'Старая цена для скидки', activeProduct: 'Товар активен', inactiveProduct: 'Товар неактивен', saving: 'Сохранение', checkoutSimpleText: 'Отправьте заказ в WhatsApp без долгого оформления. Все нужные данные откроются в модальном окне.', profileReadyOrder: 'Данные профиля найдены и будут подставлены в заказ.', profileMissingOrder: 'Если профиль не заполнен, укажите данные прямо в окне заказа.', orderModalTitle: 'Проверьте текст заказа', orderProfileFound: 'Данные профиля найдены, форма заполнена автоматически.', orderProfileMissing: 'Данных профиля пока нет. Заполните необходимые поля и отправьте заказ.', messagePreview: 'Предпросмотр сообщения', profileReadyGrooming: 'Данные профиля найдены. Имя и телефон будут подставлены в заявку на груминг.', profileMissingGrooming: 'Если профиль не заполнен, в заявке на груминг достаточно указать имя и телефон.', groomingModalTitle: 'Проверьте текст заявки на груминг'
  }
};
