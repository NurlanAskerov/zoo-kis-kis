...
const labels = {
  ...
  ru: {
    ...
    savedNote: 'Заполните один раз и используйте для следующих заказов.',
    ...
    required: 'Выберите контактные данные и способ заказа. Готовый текст будет ниже.',
    ...
    pickupMessage: 'Если товар есть в наличии, хочу прийти и забрать его из магазина.'
  }
};
